...
MHI_MODULE:
	make -C device/samsung/trlteeur/mhi/ CFLAGS_MODULE=-fno-pic KERNEL_DIR=$(KERNEL_OUT) KLIB=$(KERNEL_OUT) KLIB_BUILD=$(KERNEL_OUT) ARCH=$(TARGET_ARCH) $(ARM_CROSS_COMPILE)
